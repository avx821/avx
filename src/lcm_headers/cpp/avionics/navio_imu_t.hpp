...
int navio_imu_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int navio_imu_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int navio_imu_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t navio_imu_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* navio_imu_t::getTypeName()
{
    return "navio_imu_t";
}

int navio_imu_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int navio_imu_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
