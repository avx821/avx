...
#ifndef __avionics_vision_detection_t_hpp__
#define __avionics_vision_detection_t_hpp__


namespace avionics
{

class vision_detection_t
{
    public:
        int64_t    timestamp;
...
int vision_detection_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int vision_detection_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int vision_detection_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t vision_detection_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* vision_detection_t::getTypeName()
{
    return "vision_detection_t";
}

int vision_detection_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->frame_timestamp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int vision_detection_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->frame_timestamp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int vision_detection_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
