...
public class LCMData implements LCMSubscriber,Runnable {
		...
		public double calculateHeading() {
			double magx=(Heading_msg.imu_pos[0]/20.0)+0.25;
			double magy=(Heading_msg.imu_pos[1]/18.0)-6.35;
			...
			System.out.println("[magx,magy]:["+Heading_mag.imu_pos[0]+", "+Heading_msg.imu_pos[1]+"]");
...
public class LCMData implements LCMSubscriber,Runnable {
		...
		public double calculateHeading() {
			...
			double magheading= -Math.atan2(magy,magx)-(Math.PI/2.0) ;
